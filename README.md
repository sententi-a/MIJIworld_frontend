<div align='center'><img src="./client/src/assets/images/logo/logo.png"/><div><div style="font-family: yg-jalnan; font-size: 24px; font-weight:900;color: #8D8DE5">Eat the World, Meet the World!</div><div>당신이 알지 못했던 세계음식 맛집 소개 서비스, 미지의 세계</div></div></div>
<br>
